...
from utils.utils import adaptive_instance_normalisation, cal_mean_std
...
decoder.load_state_dict(torch.load('experiment/experiment1/decoder_final.pth',map_location=device))
